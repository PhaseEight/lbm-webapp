...
/**
 * Helper for using the mock JSF environment provided by shale-test inside unit
 * tests that do not extend {@link AbstractJsfTestCase}
 * 
...
public class JSFMockHelper {
	...
	private static class JSFMock extends AbstractJsfTestCase {
		...
		public void setUp() throws Exception {
			...
			this.facesContext = this.facesContextFactory.getFacesContext(this.servletContext, this.request,
					this.response, this.lifecycle);
