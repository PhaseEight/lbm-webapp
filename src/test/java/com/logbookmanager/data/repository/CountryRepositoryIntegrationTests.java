...
public class CountryRepositoryIntegrationTests extends IntegrationTestSupport {
    ...
    public void getCountriesAsGermanList() {
        ...
        assertTrue("The 208th country must be ZA, S�dafrika", countries.get(207).getAnsiCode().equalsIgnoreCase("ZA"));
    ...
    public void getCountriesAsJapaneseList() {
        ...
        assertTrue("The 208th country must be ZA, S�dafrika", countries.get(234).getAnsiCode().equalsIgnoreCase("ZA"));
