...
DROP TABLE PERSON;
DROP TABLE ENTRY_ATTRIBUTE;
DROP TABLE LOGBOOKUSER_LOGBOOK_ENTRY;
DROP TABLE DETAIL_ATTRIBUTE; 
DROP TABLE DETAIL;
DROP TABLE LOGBOOKUSER_CERTIFICATION;
DROP TABLE LOGBOOKUSER_LOGBOOK;
DROP TABLE LOGBOOKUSER;
DROP TABLE CERTIFICATION;
DROP TABLE ORGANISATION_COUNTRY;
DROP TABLE ORGANISATION;
DROP TABLE LOGBOOK_PAGE;
DROP TABLE LOGBOOK;
