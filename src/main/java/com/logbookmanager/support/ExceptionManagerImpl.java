...
public class ExceptionManagerImpl implements ExceptionManager {
    ...
    /* (non-Javadoc)
	 * @see com.logbookmanager.support.ExceptionManager#extractMessages(java.lang.Exception, java.lang.Exception)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see com.logbookmanager.support.ExceptionManager#formatStackTrace(java.lang.StackTraceElement[])
	 */
    @Override
