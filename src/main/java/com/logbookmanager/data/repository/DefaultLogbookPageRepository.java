...
@Repository
public class DefaultLogbookPageRepository extends HibernateRepository<LogbookPage, Long> implements LogbookPageRepository,
		Serializable {

	private static final long serialVersionUID = 912839123L;

	public DefaultLogbookPageRepository() {
	}
}
