 ...
 * =LogbookPage
 * 
 * == a logbook page maps to an activity
 * 
 */
public class LogbookPage extends EntitySupport<LogbookPage, Long> implements java.io.Serializable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.displayOrder, rhs.displayOrder).append(this.logbook, rhs.logbook)
				.append(this.name, rhs.name).append(this.id, rhs.id).append(this.version, rhs.version).isEquals();
	}
